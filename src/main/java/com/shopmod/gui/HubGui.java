...
public class HubGui extends SimpleGui {
    ...
    private void setupDisplay() {
        ...
        setSlot(41, new GuiElementBuilder(Items.GOLD_BLOCK)
            ...
            .addLoreLine(Component.literal(""))
            .addLoreLine(Component.literal("§e§l16 Games Available:"))
            ...
            .addLoreLine(Component.literal("§7• Crash"))
            .addLoreLine(Component.literal("§7• Wheel of Fortune"))
            .addLoreLine(Component.literal("§7• Keno"))
            .addLoreLine(Component.literal("§7• Mines"))
            .addLoreLine(Component.literal("§7• Plinko"))
            .addLoreLine(Component.literal("§d§l• Poker ★ NEW!"))
            .addLoreLine(Component.literal("§d§l• Baccarat ★ NEW!"))
            .addLoreLine(Component.literal("§d§l• Lottery Scratchers ★ NEW!"))
            .addLoreLine(Component.literal("§d§l• Bingo ★ NEW!"))
            .addLoreLine(Component.literal(""))
            .addLoreLine(Component.literal("§6Max Win: $500,000!"))
            .addLoreLine(Component.literal(""))
        ...
        // Row 5: Phase 5 Features
        setSlot(46, new GuiElementBuilder(Items.NETHER_STAR)
            .setName(Component.literal("§d§l⭐ Perks Shop"))
            .glow()
            .addLoreLine(Component.literal("§7Buy powerful perks & boosters!"))
            .addLoreLine(Component.literal(""))
            .addLoreLine(Component.literal("§e§lTemporary Boosters:"))
            .addLoreLine(Component.literal("§7• Income Booster (2x for 1h)"))
            .addLoreLine(Component.literal("§7• XP Booster (2x for 1h)"))
            .addLoreLine(Component.literal("§7• Luck Booster (+odds 30min)"))
            .addLoreLine(Component.literal("§7• Speed Booster (1h)"))
            .addLoreLine(Component.literal("§7• Worker Efficiency (+50%)"))
            .addLoreLine(Component.literal(""))
            .addLoreLine(Component.literal("§d§lPermanent Perks:"))
            .addLoreLine(Component.literal("§7• Golden Touch (+5% income)"))
            .addLoreLine(Component.literal("§7• VIP Status (exclusive)"))
            .addLoreLine(Component.literal("§7• And 5 more..."))
            .addLoreLine(Component.literal(""))
            .addLoreLine(Component.literal("§5§l✦ PHASE 5 FEATURE!"))
            .addLoreLine(Component.literal("§8Command: §f/perks"))
            .addLoreLine(Component.literal("§e§lCLICK §7to open"))
            .setCallback((index, type, action) -> {
                new com.shopmod.perks.PerkShopGui(player).open();
            })
        );
        
        setSlot(47, new GuiElementBuilder(Items.GOLD_BLOCK)
            .setName(Component.literal("§6§l⭐ Daily Rewards"))
            .glow()
            .addLoreLine(Component.literal("§7Claim daily rewards!"))
            .addLoreLine(Component.literal("§7Build your streak!"))
            .addLoreLine(Component.literal(""))
            .addLoreLine(Component.literal("§e§lRewards:"))
            .addLoreLine(Component.literal("§7Day 1: §6$5,000"))
            .addLoreLine(Component.literal("§7Day 3: §d+Common Mystery Box"))
            .addLoreLine(Component.literal("§7Day 5: §d+Rare Mystery Box"))
            .addLoreLine(Component.literal("§7Day 7: §6$100K §d+Epic Box"))
            .addLoreLine(Component.literal(""))
            .addLoreLine(Component.literal("§d§lMilestones:"))
            .addLoreLine(Component.literal("§730 days: §aPermanent +5% income"))
            .addLoreLine(Component.literal("§7100 days: §aPermanent +10% income"))
            .addLoreLine(Component.literal(""))
            .addLoreLine(Component.literal("§5§l✦ PHASE 5 FEATURE!"))
            .addLoreLine(Component.literal("§8Command: §f/daily"))
            .addLoreLine(Component.literal("§e§lCLICK §7to open"))
            .setCallback((index, type, action) -> {
                new com.shopmod.daily.DailyRewardGui(player).open();
            })
        );
        
        setSlot(48, new GuiElementBuilder(Items.WRITABLE_BOOK)
            .setName(Component.literal("§b§l📊 Statistics"))
            .addLoreLine(Component.literal("§7View your comprehensive stats!"))
            .addLoreLine(Component.literal(""))
            .addLoreLine(Component.literal("§e§lTrack Everything:"))
            .addLoreLine(Component.literal("§7• Total earned/spent"))
            .addLoreLine(Component.literal("§7• Properties & businesses"))
            .addLoreLine(Component.literal("§7• Stock trades & profits"))
            .addLoreLine(Component.literal("§7• Gaming stats & streaks"))
            .addLoreLine(Component.literal("§7• Workers & more"))
            .addLoreLine(Component.literal(""))
            .addLoreLine(Component.literal("§5§l✦ PHASE 5 FEATURE!"))
            .addLoreLine(Component.literal("§8Command: §f/stats"))
            .addLoreLine(Component.literal("§e§lCLICK §7to open"))
            .setCallback((index, type, action) -> {
                new com.shopmod.statistics.StatisticsGui(player).open();
            })
        );
        
        setSlot(50, new GuiElementBuilder(Items.DIAMOND)
            .setName(Component.literal("§6§l✦ Achievements"))
            .glow()
            .addLoreLine(Component.literal("§7Unlock 50+ achievements!"))
            .addLoreLine(Component.literal(""))
            .addLoreLine(Component.literal("§e§lCategories:"))
            .addLoreLine(Component.literal("§7• Wealth (Millionaire!)"))
            .addLoreLine(Component.literal("§7• Property (Real Estate Empire)"))
            .addLoreLine(Component.literal("§7• Business (Tycoon)"))
            .addLoreLine(Component.literal("§7• Gaming (Lucky Seven)"))
            .addLoreLine(Component.literal("§7• Stock Market (Warren Buffet)"))
            .addLoreLine(Component.literal("§7• Workers, Lottery, & More"))
            .addLoreLine(Component.literal(""))
            .addLoreLine(Component.literal("§6Earn cash & permanent bonuses!"))
            .addLoreLine(Component.literal("§5§l✦ PHASE 5 FEATURE!"))
            .addLoreLine(Component.literal("§8Command: §f/achievements"))
            .addLoreLine(Component.literal("§e§lCLICK §7to open"))
            .setCallback((index, type, action) -> {
                new com.shopmod.achievements.AchievementGui(player).open();
            })
        );
